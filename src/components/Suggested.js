...
function Suggested() {
  return (
    <div className="bg-gradient-radial from-red-200 to via-red-300 to-red-400 border-2 border-black rounded-md m-2">
      <h1 className="text-center p-2">Suggested Characters</h1>
      <div className="bg-gradient-radial from-purple-200 via-purple-100 to-purple-50 border-2 border-black shadow-[inset_0_-5px_6px_rgba(0,0,0,0.6)] border-black mx-8 mb-5">Characters Go Here
      </div>
    </div>
  )
};
