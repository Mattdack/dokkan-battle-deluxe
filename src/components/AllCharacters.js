...
function AllCharacters() {
  //TODO: queries in GraphQL require an object of {loading, data}. The data is then grabbed through the query object
  const { loadingAll, dataAll } = useQuery(QUERY_CHARACTERS);
  const allCharacters = dataAll?.characters || [];
