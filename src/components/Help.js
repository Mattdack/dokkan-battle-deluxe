        ...
        <div className="p-4 m-4 bg-orange-200 border-4 border-black">
            ...
            <div className="flex flex-row p-2">
                <div className="flex flex-col w-1/2 p-2 m-2 border-4 border-black bg-orange-300">
                    ...
                    <li className="text-xl font-bold">The leader and sub-leader must be the same character. This is a limitation due to the team web only allowing for one unique character.</li>
