...
function CardDetails({ cardDetails, userCharacters }) {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setCharacterType(
        process.env.PUBLIC_URL + "/dokkanIcons/types/phy-background.png"
      );
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/ephy.png"
      );
    } else if (
      ...
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/sphy.png"
      );
    } else if (
      ...
      setCharacterType(
        process.env.PUBLIC_URL + "/dokkanIcons/types/agl-background.png"
      );
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/eagl.png"
      );
    } else if (
      ...
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/sagl.png"
      );
    } else if (
      ...
      setCharacterType(
        process.env.PUBLIC_URL + "/dokkanIcons/types/str-background.png"
      );
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/estr.png"
      );
    } else if (
      ...
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/sstr.png"
      );
    } else if (
      ...
      setCharacterType(
        process.env.PUBLIC_URL + "/dokkanIcons/types/int-background.png"
      );
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/eint.png"
      );
    } else if (
      ...
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/sint.png"
      );
    } else if (
      ...
      setCharacterType(
        process.env.PUBLIC_URL + "/dokkanIcons/types/teq-background.png"
      );
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/eteq.png"
      );
    } else if (
      ...
      setCharacterSuperOrExtreme(
        process.env.PUBLIC_URL + "/dokkanIcons/types/steq.png"
      );
    }
  }, [characterId]);
