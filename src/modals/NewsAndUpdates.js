              ...
              <div className="h-3/4 lg:h-full lg:w-3/5 pb-14 border-2 border-black overflow-y-auto">
                ...
                <div className="flex flex-wrap justify-around">
                  <NewsDiv date={'MAY/1/2023'} information={<>
                    <p className="px-2 card-sm:px-4 py-2 text-md card-sm:text-base font-bold indent-4">After many requests for SSR characters, they are now available! It took some time to download all of them to the database and ensure that there were no errors. Additionally, level 10 links are now available! I have implemented an options menu for the team formation to start freeing up some space (you can access it in the top right-hand corner of the team web page). Also, you may have noticed that our primary domain has changed! If you search for <a className='text-blue-500' href="https://dokkanbattlehelper.com/">https://dokkanbattlehelper.com/</a>, you will be redirected to <a className='text-blue-500' href="https://dokkan.team/">https://dokkan.team/</a>. Both domains work, and we will be working on having all cases of dokkanbattlehelper.com redirect to dokkan.team. We are working hard to ensure our search engine optimization (SEO) is at its best so that we can reach as many users as possible, and we believe that dokkan.team will help us. Also, it's a much easier website name to remember! Both domains go to the same site, so it doesn't matter which one is used.</p> 
